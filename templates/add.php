<main>
    ...
    <form class="form form--add-lot container <?php print (isset($errors) ? 'form--invalid' : ''); ?> " action="add.php"  method="post"> <!-- form--invalid -->
        <h2>Добавление лота</h2>
        <div class="form__container-two">
            <div class="form__item <?php print (isset($errors['lot-name']) ? 'form__item--invalid' : ''); ?>"> <!-- form__item--invalid -->
